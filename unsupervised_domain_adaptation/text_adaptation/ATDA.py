...
class ATDA(object):
    ...
    def intial_training(self, inp, F1, F2, Ft, X_source_train, y_source_train,\
        ...
        modelF1F2.compile(loss=['binary_crossentropy',
                                'binary_crossentropy'], optimizer=opt,
                                metrics=['accuracy'])
    ...
    def iterate_algorithm(self, inp, F1, F2, Ft, X_source_train, y_source_train,
        ...
        for i in range(1, k):
            ...
            print '\nevaluate result: binary_crossentropy={}, accuracy={}'.format(*scores)
